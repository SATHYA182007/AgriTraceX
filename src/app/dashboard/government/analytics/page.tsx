      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[11px] font-black uppercase tracking-[0.4em] text-indigo-500">Sensor Intelligence</p>
          </div>
      ...
      <div className="grid grid-cols-1 xl:grid-cols-12 gap-10">
        ...
        <div className="xl:col-span-4">
          <div className="premium-card p-8 h-full flex flex-col items-center justify-center">
            <h3 className="text-sm font-black uppercase tracking-widest text-text-soft mb-8 w-full text-left">Risk Distribution</h3>
