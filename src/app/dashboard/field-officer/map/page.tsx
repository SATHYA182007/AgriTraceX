      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8 shrink-0">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[11px] font-black uppercase tracking-[0.4em] text-blue-500">GIS Platform</p>
          </div>
          <h1 className="text-5xl font-manrope font-extrabold tracking-tighter text-foreground">
            Realtime <span className="text-blue-500">Monitoring Map</span>
          </h1>
        </div>
        <div className="flex gap-4">
           ...
           <Button className="bg-blue-500 text-white shadow-xl shadow-blue-500/20 rounded-xl font-bold gap-2">
