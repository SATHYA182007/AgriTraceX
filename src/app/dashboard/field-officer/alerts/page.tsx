...
const ALERTS = [
  ...
  { id: 4, land: "RiverSide Farms", district: "Kolhapur", warning: "Crop Stress Detected", severity: "Medium", time: "10:15:30" },
];
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
        <div className="space-y-3">
          <div className="flex items-center gap-3">
            ...
            <p className="text-[11px] font-black uppercase tracking-[0.4em] text-blue-500">Realtime Warning Matrix</p>
          </div>
